...
const EventPage = () => {
  ...
  const filterevent = 
  eventelected === "all" 
  ? event : event.filter((event) => event.gender === eventelected);

    return (
        <div className="px-28">
      <div className="mt-5 text-white">
        <label htmlFor="event-filter" className='ml-3'>event:</label>
        <select
          id="event-filter"
        ...
        <label htmlFor="day-filter" className='ml-3'>DAY:</label>
        <select
          id="day-filter"
        ...
        <label htmlFor="time-filter" className='ml-3'>TIME:</label>
        <select
          id="time-filter"
        ...
        <label htmlFor="type-filter" className='ml-3'>TYPE:</label>
        <select
          id="type-filter"
